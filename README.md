...
| `bf_studio_light` | Blue Fox — Studio Light | 18.0.4.0.0 | LGPL-3 | Field builder for Odoo Community: add custom fields, smart buttons (count via JSON controller, no compute Python), and inject them in views without writing a module — survives `-u all` upgrades |
