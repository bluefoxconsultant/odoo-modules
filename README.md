...
| `bf_email_management` | Gestion des courriels | 18.0.6.7.0 | LGPL-3 | Unified IMAP inbox + Odoo chatter projection, two-pane OWL folder browser (Apple Mail / Thunderbird), bulk per-row target inference |
...
| `bf_hour_bank` | Banque d'heures | 18.0.1.14.0 | LGPL-3 | Automated tracking of client hour banks with threshold-based proactive notifications (unbilled hours, % of allocated budget, balance floor) |
