...
| `bf_email_management` | Gestion des courriels | 18.0.6.4.1 | LGPL-3 | Unified IMAP inbox + Odoo chatter projection, two-pane OWL folder browser (Apple Mail / Thunderbird), bulk per-row target inference |
...
| `bf_fundraising_web` | Levée de fonds — Web & Portail donateur | 18.0.1.0.1 | AGPL-3 | Public website donation form + donor portal (giving history and official receipt download) |
...
| `bf_securetransfer` | Transfert sécurisé (Secure Transfer) | 18.0.1.2.0 | LGPL-3 | Secure file transfer: browser-direct uploads to S3 (presigned, multipart), tokenized links with expiry/password/OTP, tamper-evident access log (Law 25), auto-purge, multi-brand |
