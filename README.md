...
| `bf_securetransfer` | Transfert sécurisé (Secure Transfer) | 18.0.1.2.1 | LGPL-3 | Secure file transfer: browser-direct uploads to S3 (presigned, multipart), tokenized links with expiry/password/OTP, tamper-evident access log (Law 25), auto-purge, multi-brand |
