...
| `bf_appointment` | Blue Fox Appointment | 18.0.2.28.0 | LGPL-3 | Self-service public booking pages (extends `resource_booking`) |
...
| `bf_loi25_suite` | Blue Fox — Loi 25 Suite | 18.0.1.1.0 | LGPL-3 | One-click install of the Blue Fox Quebec Loi 25 compliance stack |
...
| `bf_meeting` | Rencontres | 18.0.3.38.0 | LGPL-3 | Agendas, meeting records, and discussion items unified around `calendar.event` with automatic reminders |
...
| `bf_ops_pack` | Blue Fox — Operations Pack | 18.0.1.0.0 | LGPL-3 | Unified inbox, meetings, contact intelligence, and chatter polish for consulting/MSP teams |
...
| `bf_productivity_pack` | Blue Fox — Productivity Pack | 18.0.1.0.0 | LGPL-3 | UI polish, dashboards, command palette, notes, timer, and brand pack for Odoo CE |
