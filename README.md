...
| `bf_sms_archive` | SMS & Calls | 18.0.5.5.5 | LGPL-3 | Two-way live SMS/MMS messaging via VOIP.ms (chat workspace + systray) plus Android SMS/call-log archiving, search, PDF/CSV export and task linking |
