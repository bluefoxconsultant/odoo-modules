...
| `bf_email_management` | Gestion des courriels | 18.0.6.7.1 | LGPL-3 | Unified IMAP inbox + Odoo chatter projection, two-pane OWL folder browser (Apple Mail / Thunderbird), bulk per-row target inference |
