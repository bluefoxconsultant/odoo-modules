"""Install hook: per-language content for the booking rating email."""
from odoo.addons.bf_cx.i18n_content import apply_mail_templates_i18n

SUBJECTS_EN = {
    "mail_template_booking_rating": "How did your appointment go?",
}

TEXTS_EN = {
    "Votre avis": "Your feedback",
    "Bonjour": "Hello",
    "Merci pour votre rendez-vous avec nous. En un clic, comment "
    "évaluez-vous nos services jusqu'ici ?":
        "Thank you for your appointment with us. In one click, how would "
        "you rate our services so far?",
